...
class CfgVehicles
{
	...
	class Apple: Edible_Base
	{
		...
		inventorySlot[] = {"Ingredient","DirectCookingA","DirectCookingB","DirectCookingC","SmokingA","SmokingB","SmokingC","SmokingD","Trap_Bait"};
		containsSeedsType = "";
	...
	class RabbitLegMeat: Edible_Base
	{
		...
		class Food
		{
			class FoodStages
			{
				...
				{
					visual_properties[] = {-1,-1,5};
					nutrition_properties[] = {10,15,15,1,0,"4 + 		  16"};
					cooking_properties[] = {0,0};
				};
				class Baked
				{
	...
	class CarpFilletMeat: Edible_Base
	{
		...
		class Food
		{
			class FoodStages
			{
				...
				{
					visual_properties[] = {-1,-1,5};
					nutrition_properties[] = {10,15,30,1,0,"4 + 		  16"};
					cooking_properties[] = {0,0};
				};
				class Baked
				{
	...
	class MackerelFilletMeat: Edible_Base
	{
		...
		class Food
		{
			class FoodStages
			{
				...
				{
					visual_properties[] = {-1,-1,5};
					nutrition_properties[] = {10,10,20,1,0,"4 + 		  16"};
					cooking_properties[] = {0,0};
				};
				class Baked
				{
	...
	class Bitterlings: Edible_Base
	{
		...
		hiddenSelections[] = {"cs_raw"};
		hiddenSelectionsTextures[] = {"dz\gear\food\data\bitterlings_raw_co.paa","dz\gear\food\data\bitterlings_baked_co.paa","dz\gear\food\data\bitterlings_boiled_co.paa","dz\gear\food\data\bitterlings_dried_co.paa","dz\gear\food\data\bitterlings_burnt_co.paa"};
		hiddenSelectionsMaterials[] = {"dz\gear\food\data\bitterlings_raw.rvmat","dz\gear\food\data\bitterlings_baked.rvmat","dz\gear\food\data\bitterlings_boiled.rvmat","dz\gear\food\data\bitterlings_dried.rvmat","dz\gear\food\data\bitterlings_burnt.rvmat","dz\gear\food\data\bitterlings_rotten.rvmat"};
		class AnimationSources: FoodAnimationSources{};
		class Food
		{
			class FoodStages
			{
				...
				{
					visual_properties[] = {-1,-1,5};
					nutrition_properties[] = {10,5,10,1,0,"4 + 		  16"};
					cooking_properties[] = {0,0};
				};
				class Baked
				{
	...
	class Sardines: Edible_Base
	{
		...
		stackedUnit = "g";
		hiddenSelections[] = {"cs_raw"};
		hiddenSelectionsTextures[] = {"dz\gear\food\data\sardines_raw_CO.paa","dz\gear\food\data\sardines_baked_CO.paa","dz\gear\food\data\sardines_boiled_CO.paa","dz\gear\food\data\sardines_dried_CO.paa","dz\gear\food\data\sardines_burnt_CO.paa"};
