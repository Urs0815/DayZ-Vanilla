...
class CfgVehicles
{
	...
	class PortableGasStove: Inventory_Base
	{
		...
		hiddenSelections[] = {"flame","flameShrinked"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					hitpoints = 150;
					transferToAttachmentsCoef = 0.5;
					healthLevels[] = {{1.0,{"DZ\gear\cooking\data\Cooking_Tripod.rvmat"}},{0.7,{"DZ\gear\cooking\data\Cooking_Tripod.rvmat"}},{0.5,{"DZ\gear\cooking\data\Cooking_Tripod_damage.rvmat"}},{0.3,{"DZ\gear\cooking\data\Cooking_Tripod_damage.rvmat"}},{0.0,{"DZ\gear\cooking\data\Cooking_Tripod_destruct.rvmat"}}};
				};
			};
		};
		class AnimationSources
