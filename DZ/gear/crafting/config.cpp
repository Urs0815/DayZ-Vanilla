...
class CfgVehicles
{
	...
	class RopeLocked: Inventory_Base
	{
		...
		StruggleLength = 10;
		rotationFlags = 17;
		CanBeUnrestrainedBy[] = {"Sickle",3,"BoneKnife",3,"Hacksaw",3,"KitchenKnife",3,"SteakKnife",3,"HayHook",3,"StoneKnife",3,"Cleaver",3,"CombatKnife",3,"HuntingKnife",3,"Machete",3,"Screwdriver",3,"Crowbar",3,"Pickaxe",3,"WoodAxe",3,"Hatchet",3,"FirefighterAxe",3,"Sword",3,"AK_Bayonet",3,"M9A1_Bayonet",3,"Mosin_Bayonet",3,"SKS_Bayonet",3,"HandSaw",3,"KukriKnife",3,"FangeKnife",3};
	...
	class GasMask_Filter_Improvised: Inventory_Base
	{
		...
		hiddenSelectionsTextures[] = {"\dz\gear\crafting\gasmask_filter_improvised_co.paa"};
		class Protection
		{
			biological = 1;
			chemical = 1;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 80;
					healthLevels[] = {{1.0,{"dz\gear\crafting\data\gasmask_filter_improvised.rvmat"}},{0.7,{"dz\gear\crafting\data\gasmask_filter_improvised.rvmat"}},{0.5,{"dz\gear\crafting\data\gasmask_filter_improvised_damage.rvmat"}},{0.3,{"dz\gear\crafting\data\gasmask_filter_improvised_damage.rvmat"}},{0.0,{"dz\gear\crafting\data\gasmask_filter_improvised_destruct.rvmat"}}};
				};
			};
		};
