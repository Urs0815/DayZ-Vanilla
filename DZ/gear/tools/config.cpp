...
class CfgVehicles
{
	...
	class AlarmClock_ColorBase: Inventory_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"dz\weapons\attachments\optics\data\lensglass_ca.paa","dz\gear\tools\data\alarmclock_glass.rvmat","dz\gear\tools\data\alarmclock.rvmat","dz\gear\tools\data\alarmclock_arrows.rvmat","dz\gear\tools\data\alarmclock_arrows_destruct.rvmat"}},{0.7,{}},{0.5,{"dz\weapons\attachments\optics\data\lensglass_damage_ca.paa","dz\gear\tools\data\alarmclock_glass_damage.rvmat","dz\gear\tools\data\alarmclock_damage.rvmat","dz\gear\tools\data\alarmclock_arrows_damage.rvmat","dz\gear\tools\data\alarmclock_arrows_destruct.rvmat"}},{0.3,{}},{0.0,{"dz\weapons\attachments\optics\data\lensglass_destruct_ca.paa","dz\gear\tools\data\alarmclock_glass_destruct.rvmat","dz\gear\tools\data\alarmclock_destruct.rvmat","dz\gear\tools\data\alarmclock_arrows_destruct.rvmat","dz\gear\tools\data\alarmclock_arrows.rvmat"}}};
				};
			};
		};
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"dz\gear\tools\data\alarmclock_co.paa"};
	};
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"dz\gear\tools\data\alarmclock_green_co.paa"};
	};
	class KitchenTimer: Inventory_Base
	{
		...
		hiddenSelections[] = {"camo"};
		hiddenSelectionsTextures[] = {"dz\gear\tools\data\kitchentimer_co.paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 30;
					healthLevels[] = {{1.0,{"DZ\gear\tools\data\KitchenTimer.rvmat"}},{0.7,{"DZ\gear\tools\data\KitchenTimer.rvmat"}},{0.5,{"DZ\gear\tools\data\KitchenTimer_damage.rvmat"}},{0.3,{"DZ\gear\tools\data\KitchenTimer_damage.rvmat"}},{0.0,{"DZ\gear\tools\data\KitchenTimer_destruct.rvmat"}}};
				};
			};
		};
		soundImpactType = "metal";
	...
	class BoneKnife: Inventory_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 45;
					healthLevels[] = {{1.0,{"DZ\gear\tools\data\Bone_Knife.rvmat"}},{0.7,{"DZ\gear\tools\data\Bone_Knife.rvmat"}},{0.5,{"DZ\gear\tools\data\Bone_Knife_damage.rvmat"}},{0.3,{"DZ\gear\tools\data\Bone_Knife_damage.rvmat"}},{0.0,{"DZ\gear\tools\data\Bone_Knife_destruct.rvmat"}}};
				};
			};
		};
		class MeleeModes
	...
	class Broom: Inventory_Base
	{
		...
		hiddenSelectionsMaterials[] = {"dz\gear\tools\data\broom.rvmat"};
		rotationFlags = 12;
		quantityShow = 0;
		canBeSplit = 0;
		stackedUnit = "w";
	...
	class Broom_Birch: Broom
	{
		...
		hiddenSelections[] = {"zbytek"};
		hiddenSelectionsMaterials[] = {"dz\gear\tools\data\broom_birch.rvmat"};
		rotationFlags = 12;
		itemSize[] = {2,8};
		inventorySlot[] = {"Shoulder","Melee"};
		varWetMax = 0.49;
	...
	class FireworksLauncher: Inventory_Base
	{
		...
		hiddenSelectionsTextures[] = {"dz\gear\tools\data\FireworksLauncher_co.paa","dz\gear\tools\data\FireworksLauncher_co.paa"};
		hiddenSelectionsMaterials[] = {"dz\gear\tools\data\FireworksLauncher.rvmat","dz\gear\tools\data\FireworksLauncher.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 30;
					healthLevels[] = {{1.0,{"DZ\gear\tools\data\FireworksLauncher.rvmat"}},{0.7,{"DZ\gear\tools\data\FireworksLauncher.rvmat"}},{0.5,{"DZ\gear\tools\data\FireworksLauncher_damage.rvmat"}},{0.3,{"DZ\gear\tools\data\FireworksLauncher_damage.rvmat"}},{0.0,{"DZ\gear\tools\data\FireworksLauncher_destruct.rvmat"}}};
				};
			};
		};
