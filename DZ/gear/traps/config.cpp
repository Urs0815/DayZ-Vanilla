...
class CfgVehicles
{
	...
	class SmallFishTrap: Trap_Base
	{
		...
		itemBehaviour = 1;
		hiddenSelections[] = {"placing"};
		hiddenSelectionsTextures[] = {"dz\gear\drinks\Data\loot_waterbottle_co.paa"};
	...
	class FishNetTrap: Trap_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"dz\gear\traps\data\fishnettrap.rvmat"}},{0.7,{"dz\gear\traps\data\fishnettrap.rvmat"}},{0.5,{"dz\gear\traps\data\fishnettrap_damage.rvmat"}},{0.3,{"dz\gear\traps\data\fishnettrap_damage.rvmat"}},{0.0,{"dz\gear\traps\data\fishnettrap_destruct.rvmat"}}};
				};
			};
		};
		class AnimationSources
	...
	class TripwireTrap: Trap_Base
	{
		...
		itemBehaviour = 1;
		hiddenSelections[] = {"placing"};
		hiddenSelectionsTextures[] = {"dz\gear\traps\data\snaretrap_co.paa"};
		hiddenSelectionsMaterials[] = {"dz\gear\traps\data\snaretrap.rvmat"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"dz\gear\traps\data\snaretrap.rvmat"}},{0.7,{"dz\gear\traps\data\snaretrap.rvmat"}},{0.5,{"dz\gear\traps\data\snaretrap_damage.rvmat"}},{0.3,{"dz\gear\traps\data\snaretrap_damage.rvmat"}},{0.0,{"dz\gear\traps\data\snaretrap_destruct.rvmat"}}};
				};
			};
		};
		class AnimationSources
