...
class CfgMagazines
{
	...
	class Ammo_40mm_Base: Ammunition_Base
	{
		...
		inventorySlot[] = {"IEDExplosiveA","IEDExplosiveB","VestGrenadeA","VestGrenadeB","VestGrenadeC","VestGrenadeD"};
		muzzleFlashParticle = "weapon_shot_izh18_01";
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"DZ\weapons\ammunition\data\40mm_grenade.rvmat"}},{0.7,{"DZ\weapons\ammunition\data\40mm_grenade.rvmat"}},{0.5,{"DZ\weapons\ammunition\data\40mm_grenade_damage.rvmat"}},{0.3,{"DZ\weapons\ammunition\data\40mm_grenade_damage.rvmat"}},{0.0,{"DZ\weapons\ammunition\data\40mm_grenade_destruct.rvmat"}}};
				};
			};
		};
	};
