...
class CfgAmmo
{
	...
	{
		indirectHitRange = 1;
		indirectHitRangeMultiplier = 2.0;
		class DamageApplied
		{
			type = "FragGrenade";
			class Health
	...
	class Plastic_Explosive_Ammo: DefaultAmmo
	{
		indirectHit = 1;
		indirectHitRange = 1;
		indirectHitRangeMultiplier = 20.0;
		explosive = 1;
		typicalSpeed = 3;
		initSpeed = 3;
		simulation = "shotShell";
		simulationStep = 0.05;
		soundSetExplosion[] = {"Plastic_Explosion_SoundSet","Plastic_Explosion_Tail_SoundSet"};
		class DamageApplied
		{
			type = "FragGrenade";
			class Health
	...
	class ClaymoreMine_Ammo: DefaultAmmo
	{
		indirectHit = 1;
		indirectHitRange = 10;
		indirectHitRangeMultiplier = 3.0;
		explosive = 1;
		typicalSpeed = 3;
		initSpeed = 3;
		indirectHitAngle1 = 45.0;
		indirectHitAngle2 = 45.0;
...
class CfgVehicles
{
	...
	class Grenade_ChemGas: Grenade_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 5;
					healthLevels[] = {{1.0,{"DZ\weapons\explosives\data\Grenade_ChemGas.rvmat"}},{0.7,{"DZ\weapons\explosives\data\Grenade_ChemGas.rvmat"}},{0.5,{"DZ\weapons\explosives\data\Grenade_ChemGas_damage.rvmat"}},{0.3,{"DZ\weapons\explosives\data\Grenade_ChemGas_damage.rvmat"}},{0.0,{"DZ\weapons\explosives\data\Grenade_ChemGas_destruct.rvmat"}}};
				};
			};
		};
	};
	class Plastic_Explosive: ExplosivesBase
	{
		...
		hiddenSelectionsTextures[] = {"dz\weapons\explosives\data\Plastic_Explosive.paa"};
		hiddenSelectionsMaterials[] = {"dz\weapons\explosives\data\Plastic_Explosive.rvmat"};
		attachments[] = {"TriggerRemoteDetonator_Receiver"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"DZ\weapons\explosives\data\Plastic_Explosive.rvmat"}},{0.7,{"DZ\weapons\explosives\data\Plastic_Explosive.rvmat"}},{0.5,{"DZ\weapons\explosives\data\Plastic_Explosive_damage.rvmat"}},{0.3,{"DZ\weapons\explosives\data\Plastic_Explosive_damage.rvmat"}},{0.0,{"DZ\weapons\explosives\data\Plastic_Explosive_destruct.rvmat"}}};
				};
			};
		};
	};
	...
	class ClaymoreMine: ExplosivesBase
	{
		...
		hiddenSelectionsTextures[] = {"dz\weapons\explosives\data\claymore_co.paa"};
		hiddenSelectionsMaterials[] = {"DZ\gear\tools\data\RemoteDetonator_LED.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"DZ\weapons\explosives\data\Claymore.rvmat","DZ\weapons\explosives\data\Claymore_Bag.rvmat"}},{0.7,{"DZ\weapons\explosives\data\Claymore.rvmat","DZ\weapons\explosives\data\Claymore_Bag.rvmat"}},{0.5,{"DZ\weapons\explosives\data\Claymore_damage.rvmat","DZ\weapons\explosives\data\Claymore_Bag_damage.rvmat"}},{0.3,{"DZ\weapons\explosives\data\Claymore_damage.rvmat","DZ\weapons\explosives\data\Claymore_Bag_damage.rvmat"}},{0.0,{"DZ\weapons\explosives\data\Claymore_destruct.rvmat","DZ\weapons\explosives\data\Claymore_Bag_destruct.rvmat"}}};
				};
			};
		};
		class AnimationSources
	...
	class ClaymoreMinePlacing: ClaymoreMine
	{
		...
		hiddenSelections[] = {"placing"};
		hiddenSelectionsTextures[] = {"dz\weapons\explosives\data\claymore_co.paa"};
		hiddenSelectionsMaterials[] = {"dz\weapons\explosives\data\claymore.rvmat"};
		class AnimationSources
		{
			class Inventory
			{
	...
	class ImprovisedExplosive: ExplosivesBase
	{
		...
		hiddenSelections[] = {"zbytek"};
		hiddenSelectionsTextures[] = {"dz\weapons\explosives\data\ied_co.paa"};
		hiddenSelectionsMaterials[] = {"dz\weapons\explosives\data\ied.rvmat"};
		attachments[] = {"TriggerAlarmClock","TriggerKitchenTimer","TriggerRemoteDetonator_Receiver","IEDExplosiveA","IEDExplosiveB"};
		class AnimationSources
		{
			class TriggerEmpty
			{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"DZ\weapons\explosives\data\ied.rvmat","DZ\gear\containers\data\Protector_Case.rvmat"}},{0.7,{"DZ\weapons\explosives\data\ied.rvmat","DZ\gear\containers\data\Protector_Case.rvmat"}},{0.5,{"DZ\weapons\explosives\data\ied_damage.rvmat","DZ\gear\containers\data\Protector_Case_damage.rvmat"}},{0.3,{"DZ\weapons\explosives\data\ied_damage.rvmat","DZ\gear\containers\data\Protector_Case_damage.rvmat"}},{0.0,{"DZ\weapons\explosives\data\ied_destruct.rvmat","DZ\gear\containers\data\Protector_Case_destruct.rvmat"}}};
				};
			};
		};
	};
