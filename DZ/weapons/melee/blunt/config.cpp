	...
	class BaseballBat: Inventory_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 250;
					healthLevels[] = {{1.0,{"DZ\weapons\melee\blunt\Data\BaseballBat.rvmat"}},{0.7,{"DZ\weapons\melee\blunt\Data\BaseballBat.rvmat"}},{0.5,{"DZ\weapons\melee\blunt\Data\BaseballBat_damage.rvmat"}},{0.3,{"DZ\weapons\melee\blunt\Data\BaseballBat_damage.rvmat"}},{0.0,{"DZ\weapons\melee\blunt\Data\BaseballBat_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
	...
	class BarbedBaseballBat: Inventory_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 250;
					healthLevels[] = {{1.0,{"DZ\weapons\melee\blunt\Data\BaseballBat_barbed.rvmat","DZ\weapons\melee\blunt\Data\Barbed_wire_bloody.rvmat"}},{0.7,{"DZ\weapons\melee\blunt\Data\BaseballBat_barbed.rvmat","DZ\weapons\melee\blunt\Data\Barbed_wire_bloody.rvmat"}},{0.5,{"DZ\weapons\melee\blunt\Data\BaseballBat_barbed_damage.rvmat","DZ\weapons\melee\blunt\Data\Barbed_wire_bloody_damage.rvmat"}},{0.3,{"DZ\weapons\melee\blunt\Data\BaseballBat_barbed_damage.rvmat","DZ\weapons\melee\blunt\Data\Barbed_wire_bloody_damage.rvmat"}},{0.0,{"DZ\weapons\melee\blunt\Data\BaseballBat_barbed_destruct.rvmat","DZ\weapons\melee\blunt\Data\Barbed_wire_bloody_destruct.rvmat"}}};
				};
			};
		};
		class MeleeModes
