...
class cfgVehicles
{
	...
	class PP19_Bttstck: Inventory_Base
	{
		...
		swayModifier[] = {0.7,0.7,0.7};
		hiddenSelections[] = {"camo"};
		hiddenSelectionsTextures[] = {"dz\weapons\attachments\support\data\buttstock_pp19_CO.paa"};
		hiddenSelectionsMaterials[] = {"dz\weapons\attachments\support\data\buttstock_PP_19.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 250;
					healthLevels[] = {{1.0,{"DZ\weapons\attachments\support\data\buttstock_PP_19.rvmat"}},{0.7,{"DZ\weapons\attachments\support\data\buttstock_PP_19.rvmat"}},{0.5,{"DZ\weapons\attachments\support\data\buttstock_PP_19_damage.rvmat"}},{0.3,{"DZ\weapons\attachments\support\data\buttstock_PP_19_damage.rvmat"}},{0.0,{"DZ\weapons\attachments\support\data\buttstock_PP_19_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
