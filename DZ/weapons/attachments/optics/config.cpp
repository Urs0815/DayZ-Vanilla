	...
	class StarlightOptic: ItemOptics
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 30;
					healthLevels[] = {{1.0,{"dz\weapons\attachments\data\scope_alpha_clear_ca.paa","DZ\weapons\attachments\optics\data\optic_starlight.rvmat","DZ\weapons\attachments\optics\data\optic_starlight_cover.rvmat"}},{0.7,{}},{0.5,{"dz\weapons\attachments\data\scope_alpha_damaged_ca.paa","DZ\weapons\attachments\optics\data\optic_starlight_damage.rvmat","DZ\weapons\attachments\optics\data\optic_starlight_cover_damage.rvmat"}},{0.3,{}},{0.0,{"dz\weapons\attachments\data\scope_alpha_destroyed_ca.paa","DZ\weapons\attachments\optics\data\optic_starlight_destruct.rvmat","DZ\weapons\attachments\optics\data\optic_starlight_cover_destruct.rvmat"}}};
				};
			};
		};
		class OpticsInfo
		{
			...
			discreteDistance[] = {100,200,300,400,500,600,700};
			discreteDistanceInitIndex = 0;
			PPMaskProperties[] = {0.5,0.5,0.5,0.06};
			PPLensProperties[] = {-0.9,1.0,0,0};
			PPBlurProperties = 0.75;
		};
		class AnimationSources
		{
