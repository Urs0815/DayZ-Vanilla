...
class CfgMagazines
{
	...
	class Mag_Aug_30Rnd: Magazine_Base
	{
		...
		tracersEvery = 0;
		hiddenSelections[] = {"camo"};
		hiddenSelectionsTextures[] = {"DZ\weapons\attachments\magazine\data\aug_mag_co.paa"};
		hiddenSelectionsMaterials[] = {"DZ\weapons\attachments\magazine\data\aug_mag.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 100;
					healthLevels[] = {{1.0,{"DZ\weapons\attachments\magazine\data\aug_mag.rvmat"}},{0.7,{"DZ\weapons\attachments\magazine\data\aug_mag.rvmat"}},{0.5,{"DZ\weapons\attachments\magazine\data\aug_mag_damage.rvmat"}},{0.3,{"DZ\weapons\attachments\magazine\data\aug_mag_damage.rvmat"}},{0.0,{"DZ\weapons\attachments\magazine\data\aug_mag_destruct.rvmat"}}};
				};
			};
		};
		class AnimEventse
	...
	class Mag_PP19_64Rnd: Magazine_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 100;
					healthLevels[] = {{1.0,{"DZ\weapons\attachments\magazine\data\magazine_PP_19.rvmat"}},{0.7,{"DZ\weapons\attachments\magazine\data\magazine_PP_19.rvmat"}},{0.5,{"DZ\weapons\attachments\magazine\data\magazine_PP_19_damage.rvmat"}},{0.3,{"DZ\weapons\attachments\magazine\data\magazine_PP_19_damage.rvmat"}},{0.0,{"DZ\weapons\attachments\magazine\data\magazine_PP_19_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
	...
	class Mag_CZ550_4rnd: Magazine_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 100;
					healthLevels[] = {{1.0,{"DZ\weapons\attachments\magazine\data\magazine_cz550_4rnd.rvmat"}},{0.7,{"DZ\weapons\attachments\magazine\data\magazine_cz550_4rnd.rvmat"}},{0.5,{"DZ\weapons\attachments\magazine\data\magazine_cz550_4rnd_damage.rvmat"}},{0.3,{"DZ\weapons\attachments\magazine\data\magazine_cz550_4rnd_damage.rvmat"}},{0.0,{"DZ\weapons\attachments\magazine\data\magazine_cz550_4rnd_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
