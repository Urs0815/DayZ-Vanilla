...
class CfgVehicles
{
	...
	class EffectArea: HouseNoDestruct
	{
		scope = 1;
	};
	...
	class ContaminatedArea_Local: EffectArea
	{
		scope = 2;
	};
...
class cfgAmmoTypes
{
	...
	class AType_Bullet_40mm_Explosive
	{
		name = "Bullet_40mm_Explosive";
	};
	class AType_Bullet_40mm_ChemGas
	{
		name = "Bullet_40mm_ChemGas";
	};
	class AType_Bullet_40mm_Smoke_Red
	{
		name = "Bullet_40mm_Smoke_Red";
	};
	class AType_Bullet_40mm_Smoke_Green
	{
		name = "Bullet_40mm_Smoke_Green";
	};
	class AType_Bullet_40mm_Smoke_White
	{
		name = "Bullet_40mm_Smoke_White";
	};
	class AType_Bullet_40mm_Smoke_Black
	{
		name = "Bullet_40mm_Smoke_Black";
	};
};
