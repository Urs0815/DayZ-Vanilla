...
//'now' is Tue Aug 23 21:39:23 2022 : 'file' last modified on Tue Apr 05 09:26:32 2022
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class GorkaPants_Summer: GorkaPants_ColorBase
	{
		scope = 2;
		visibilityModifier = 0.75;
		hiddenSelectionsTextures[] = {"DZ\characters\pants\data\gorkapants_dropped_summer_CO.paa","DZ\characters\pants\data\gorka_pants_summer_CO.paa","DZ\characters\pants\data\gorka_pants_summer_CO.paa"};
	};
	class GorkaPants_Autumn: GorkaPants_ColorBase
	{
		scope = 2;
		visibilityModifier = 0.6;
		hiddenSelectionsTextures[] = {"DZ\characters\pants\data\gorkapants_dropped_autumn_CO.paa","DZ\characters\pants\data\gorka_pants_autumn_CO.paa","DZ\characters\pants\data\gorka_pants_autumn_CO.paa"};
	};
	class GorkaPants_Flat: GorkaPants_ColorBase
	{
		scope = 2;
		visibilityModifier = 0.7;
		hiddenSelectionsTextures[] = {"DZ\characters\pants\data\gorkapants_dropped_flat_CO.paa","DZ\characters\pants\data\gorka_pants_flat_CO.paa","DZ\characters\pants\data\gorka_pants_flat_CO.paa"};
	};
	class GorkaPants_PautRev: GorkaPants_ColorBase
	{
		scope = 2;
		visibilityModifier = 0.75;
		hiddenSelectionsTextures[] = {"DZ\characters\pants\data\gorkapants_dropped_PautRev_CO.paa","DZ\characters\pants\data\gorka_pants_PautRev_CO.paa","DZ\characters\pants\data\gorka_pants_PautRev_CO.paa"};
	};
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"\dz\characters\pants\data\NBC_Pants_yellow_co.paa","\dz\characters\pants\data\NBC_Pants_yellow_co.paa","\dz\characters\pants\data\NBC_Pants_yellow_co.paa"};
	};
	...
	class LegsCover_Improvised: Clothing
	{
		...
		repairCosts[] = {25.0};
		hiddenSelections[] = {"camoGround","camoMale","camoFemale","personality"};
		hiddenSelectionsTextures[] = {"dz\characters\pants\data\LegCover_Improvised_co.paa","dz\characters\pants\data\LegCover_Improvised_co.paa","dz\characters\pants\data\LegCover_Improvised_co.paa"};
		class ClothingTypes
		{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"DZ\characters\pants\Data\LegCover_Improvised.rvmat"}},{0.7,{"DZ\characters\pants\Data\LegCover_Improvised.rvmat"}},{0.5,{"DZ\characters\pants\Data\LegCover_Improvised_damage.rvmat"}},{0.3,{"DZ\characters\pants\Data\LegCover_Improvised_damage.rvmat"}},{0.0,{"DZ\characters\pants\Data\LegCover_Improvised_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
