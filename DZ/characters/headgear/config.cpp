...
class CfgVehicles
{
	...
	class HeadCover_Improvised: Clothing
	{
		...
		hiddenSelectionsTextures[] = {"dz\characters\headgear\data\headCover_improvised_CO.paa","dz\characters\headgear\data\headCover_improvised_CO.paa","dz\characters\headgear\data\headCover_improvised_CO.paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"DZ\characters\headgear\data\headCover_improvised.rvmat"}},{0.7,{"DZ\characters\headgear\data\headCover_improvised.rvmat"}},{0.5,{"DZ\characters\headgear\data\headCover_improvised_damage.rvmat"}},{0.3,{"DZ\characters\headgear\data\headCover_improvised_damage.rvmat"}},{0.0,{"DZ\characters\headgear\data\headCover_improvised_destruct.rvmat"}}};
				};
			};
		};
		class ClothingTypes
	...
	class ConstructionHelmet_ColorBase: Clothing
	{
		...
		varWetMax = 0.249;
		heatIsolation = 0.1;
		headSelectionsToHide[] = {"Clipping_headCover_improvised"};
		hiddenSelections[] = {"camoGround","camoMale","camoFemale"};
		class DamageSystem
		{
			class GlobalHealth
	...
	class BurlapSackCover: Clothing
	{
		...
		varWetMax = 1.0;
		heatIsolation = 0.3;
		headSelectionsToHide[] = {"Clipping_BurlapSack"};
		hiddenSelections[] = {"camoGround","camoMale","camoFemale"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[] = {{1.0,{"DZ\characters\headgear\data\pumpkin_emissive.rvmat"}},{0.7,{"DZ\characters\headgear\data\pumpkin_emissive.rvmat"}},{0.5,{"DZ\characters\headgear\data\pumpkin_emissive_damage.rvmat"}},{0.3,{"DZ\characters\headgear\data\pumpkin_emissive_damage.rvmat"}},{0.0,{"DZ\characters\headgear\data\pumpkin_emissive_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"DZ\characters\headgear\data\MotoHelmet_yellow_co.paa","DZ\characters\headgear\data\MotoHelmetVisor_dark_co.paa"};
	...
	class DarkMotoHelmet_YellowScarred: DarkMotoHelmet_ColorBase
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 60;
					healthLevels[] = {{1.0,{"DZ\characters\headgear\data\MotoHelmet.rvmat","DZ\characters\headgear\data\motohelmetvisor_nontrans.rvmat","DZ\characters\headgear\data\motohelmet_scarred.rvmat","DZ\characters\headgear\data\MotoHelmetVisor_scarred.rvmat"}},{0.7,{"DZ\characters\headgear\data\MotoHelmet.rvmat","DZ\characters\headgear\data\motohelmetvisor_nontrans.rvmat","DZ\characters\headgear\data\motohelmet_scarred.rvmat","DZ\characters\headgear\data\MotoHelmetVisor_scarred.rvmat"}},{0.5,{"DZ\characters\headgear\data\MotoHelmet_damage.rvmat","DZ\characters\headgear\data\motohelmetvisor_nontrans_damage.rvmat","DZ\characters\headgear\data\motohelmet_scarred_damage.rvmat","DZ\characters\headgear\data\MotoHelmetVisor_scarred_damage.rvmat"}},{0.3,{"DZ\characters\headgear\data\MotoHelmet_damage.rvmat","DZ\characters\headgear\data\motohelmetvisor_nontrans_damage.rvmat","DZ\characters\headgear\data\motohelmet_scarred_damage.rvmat","DZ\characters\headgear\data\MotoHelmetVisor_scarred_damage.rvmat"}},{0.0,{"DZ\characters\headgear\data\MotoHelmet_destruct.rvmat","DZ\characters\headgear\data\motohelmetvisor_nontrans_destruct.rvmat","DZ\characters\headgear\data\motohelmet_scarred_destruct.rvmat","DZ\characters\headgear\data\MotoHelmetVisor_scarred_destruct.rvmat"}}};
				};
			};
			class GlobalArmor
			{
	...
	class ZmijovkaCap_ColorBase: Clothing
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 40;
					healthLevels[] = {{1.0,{"DZ\characters\headgear\data\ZmijovkaCap.rvmat"}},{0.7,{"DZ\characters\headgear\data\ZmijovkaCap.rvmat"}},{0.5,{"DZ\characters\headgear\data\ZmijovkaCap_damage.rvmat"}},{0.3,{"DZ\characters\headgear\data\ZmijovkaCap_damage.rvmat"}},{0.0,{"DZ\characters\headgear\data\ZmijovkaCap_destruct.rvmat"}}};
				};
			};
		};
		class ClothingTypes
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"\dz\characters\headgear\data\NBC_Hood_yellow_co.paa","\dz\characters\headgear\data\NBC_Hood_yellow_co.paa","\dz\characters\headgear\data\NBC_Hood_yellow_co.paa"};
	};
