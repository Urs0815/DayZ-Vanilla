...
//'now' is Wed Oct 19 20:09:17 2022 : 'file' last modified on Tue Apr 05 09:17:55 2022
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class HandsCover_Improvised: Clothing
	{
		...
		repairCosts[] = {25.0};
		hiddenSelections[] = {"camoGround","camoMale","camoFemale","personality"};
		hiddenSelectionsTextures[] = {"dz\characters\gloves\data\handsCover_improvised_co.paa","dz\characters\gloves\data\handsCover_improvised_co.paa","dz\characters\gloves\data\handsCover_improvised_co.paa","dz\characters\gloves\data\handsCover_improvised_co.paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"DZ\Characters\gloves\data\handsCover_improvised.rvmat"}},{0.7,{"DZ\Characters\gloves\data\handsCover_improvised.rvmat"}},{0.5,{"DZ\Characters\gloves\data\handsCover_improvised_damage.rvmat"}},{0.3,{"DZ\Characters\gloves\data\handsCover_improvised_damage.rvmat"}},{0.0,{"DZ\Characters\gloves\data\handsCover_improvised_destruct.rvmat"}}};
				};
			};
		};
		class ClothingTypes
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"\dz\characters\gloves\Data\NBC_Gloves_yellow_co.paa","\dz\characters\gloves\Data\NBC_Gloves_yellow_co.paa","\dz\characters\gloves\Data\NBC_Gloves_yellow_co.paa"};
	};
