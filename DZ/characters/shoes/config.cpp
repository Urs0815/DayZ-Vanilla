...
class CfgVehicles
{
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"\dz\characters\shoes\data\NBC_Boots_yellow_co.paa","\dz\characters\shoes\data\NBC_Boots_yellow_co.paa","\dz\characters\shoes\data\NBC_Boots_yellow_co.paa"};
	};
	...
	class FeetCover_Improvised: Clothing
	{
		...
		repairCosts[] = {25.0};
		hiddenSelections[] = {"camoGround","camoMale","camoFemale","personality"};
		hiddenSelectionsTextures[] = {"dz\characters\shoes\data\feetCover_improvised_co.paa","dz\characters\shoes\data\feetCover_improvised_co.paa","dz\characters\shoes\data\feetCover_improvised_co.paa"};
		class ClothingTypes
		{
