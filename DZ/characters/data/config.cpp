...
class CfgVehicles
{
	...
	class SurvivorF_Baty: SurvivorFemale_Base
	{
		...
		{
			tex[] = {};
			mat[] = {"dz\characters\heads\data\f_Baty\hhl_f_Baty_body.rvmat","dz\characters\heads\data\f_Baty\hhl_f_Baty_body_injury.rvmat","dz\characters\heads\data\f_Baty\hhl_f_Baty_body_injury2.rvmat"};
		};
		voiceType = 2;
	};
};
