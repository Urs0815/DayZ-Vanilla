...
class CfgVehicles
{
	...
	class GasMask: Clothing
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 120;
					healthLevels[] = {{1.0,{"DZ\characters\masks\data\GasMask.rvmat","DZ\characters\masks\data\GasMask_Glass.rvmat"}},{0.7,{"DZ\characters\masks\data\GasMask.rvmat","DZ\characters\masks\data\GasMask_Glass.rvmat"}},{0.5,{"DZ\characters\masks\data\GasMask_damage.rvmat","DZ\characters\masks\data\GasMask_Glass_damage.rvmat"}},{0.3,{"DZ\characters\masks\data\GasMask_damage.rvmat","DZ\characters\masks\data\GasMask_Glass_damage.rvmat"}},{0.0,{"DZ\characters\masks\data\GasMask_destruct.rvmat","DZ\characters\masks\data\GasMask_Glass_destruct.rvmat"}}};
				};
			};
		};
		class ClothingTypes
	...
	class FaceCover_Improvised: Clothing
	{
		...
		headSelectionsToHide[] = {"Clipping_Surgical_mask"};
		hiddenSelectionsTextures[] = {"dz\characters\masks\data\FaceCover_Improvised_co.paa","dz\characters\masks\data\FaceCover_Improvised_co.paa","dz\characters\masks\data\FaceCover_Improvised_co.paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 50;
					healthLevels[] = {{1.0,{"DZ\characters\masks\data\FaceCover_Improvised.rvmat"}},{0.7,{"DZ\characters\masks\data\FaceCover_Improvised.rvmat"}},{0.5,{"DZ\characters\masks\data\FaceCover_Improvised_damage.rvmat"}},{0.3,{"DZ\characters\masks\data\FaceCover_Improvised_damage.rvmat"}},{0.0,{"DZ\characters\masks\data\FaceCover_Improvised_destruct.rvmat"}}};
				};
			};
		};
		class ClothingTypes
