...
//'now' is Wed Oct 19 20:09:41 2022 : 'file' last modified on Fri Oct 07 12:52:37 2022
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class ZmbM_Santa: ZmbM_priestPopSkinny_Base
	{
		...
		hiddenSelectionsTextures[] = {"dz\characters\zombies\data\santa_co.paa"};
		hiddenSelectionsMaterials[] = {"dz\characters\zombies\data\santa.rvmat"};
	...
	class ZmbM_Mummy: ZombieMaleBase
	{
		...
		meleeAmmo = "MeleeZombieMummy";
		class AttackActions: AttackActions
		{
			class AttackLong: AttackLong
			{
				ammoType = "MeleeZombieMummy";
			};
			class AttackRun: AttackRun
			{
				ammoType = "MeleeZombieMummy";
		...
		hiddenSelectionsTextures[] = {"dz\characters\zombies\data\Mummy_co.paa"};
		hiddenSelectionsMaterials[] = {"dz\characters\zombies\data\Mummy.rvmat"};
